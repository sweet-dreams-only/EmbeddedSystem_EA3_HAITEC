...
# endif
# if (defined RTE_CONST_NXTR) || (defined NXTR)
#  if (!defined RTE_CONST_NXTR) || (RTE_CONST_NXTR != 126U)
#   error "Enumeration constant <NXTR> conflicts with another constant."
#  endif
# else
#  define RTE_CONST_NXTR (126U)
#  define NXTR (126U)
# endif
