															...
															VAR(float32, AUTOMATIC) CrsMtrVel_MtrRadpS_T_f32)
{
	...
	CrsMtrVel_MtrRadpS_T_s11p4 = FPM_FloatToFixed_m(CrsMtrVel_MtrRadpS_T_f32, s11p4_T); /* PRQA S 4395 */  /* MISRA-C:2004 Rule 10.4: Deviation to use Nxtr library functions */
	...
	MtrVelBlendPct_Uls_T_u2p14 = IntplVarXY_u16_u16Xu16Y_Cnt(	t_MtrVelBlendTblX_MtrRadpS_u12p4,
																...
																Abs_s16_m(CrsMtrVel_MtrRadpS_T_s11p4)); /* PRQA S 4393 */ /* MISRA-C:2004 Rule 10.3: Deviation to use Nxtr library functions */
